...
def build_model_with_cfg(
    ...
    print('model_cfg: ', dir(model_cfg))
    print('model_cls: ', dir(model_cls))
    print('kwargs: ', kwargs)
    # print(dir(kwargs['cfg']))
    if model_cfg is None:
        model = model_cls(FQcfg=FQcfg, **kwargs)
    else:
        # model = model_cls(cfg=model_cfg, **kwargs)
        model = model_cls(cfg=model_cfg, FQcfg=FQcfg, **kwargs)
